...
8. In Github, navigate to this code repository's main page and click the button that reads "Compare & pull request".
...
For a set of basic rules and guidelines for developing Angular components, see [here](https://angular.io/guide/styleguide).
...
We enforce some style rules for code in this repository using [tslint](https://palantir.github.io/tslint/). You can install a linting addon to a lot of editors and IDEs that will follow our linting rules.
