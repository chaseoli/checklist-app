...
export interface IEncryptedResult { encryptedText: string, secret: string, iv: string }
...
class _Encrypt {
     ...
     * @memberof Encryption
     */
    encrypt(text: string): IEncryptedResult {
...
export function encrypt(text: string): IEncryptedResult {
