...
export TS_NODE_PROJECT="apis/admin/tsconfig.admin-api.dev-tests.json" 
...
export GOOGLE_APPLICATION_CREDENTIALS=".credentials/dev/admin-service-account.json" 
node apis/admin/node_modules/mocha/bin/_mocha --require \
ts-node/register --timeout 999999 --colors apis/admin/src/**/*.spec.ts